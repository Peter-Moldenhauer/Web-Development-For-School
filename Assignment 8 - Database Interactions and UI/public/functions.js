// Most of these funtions will relate to the "DOM and Events" section of lecture material

// Function to create an edit button to be placed in each row in the table 
function editBtn() {
...
// Function to create a delete button to be placed in each row in the table 
function deleteBtn() {
...
// Function to build a query string when adding a new element to the table
...
// Function to add a workout exercise to the table
function addWorkout() {
...
// Source: https://jsfiddle.net/GRgMb/.
